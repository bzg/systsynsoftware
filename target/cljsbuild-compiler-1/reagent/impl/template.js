...
var G__10694 = o;
(G__10694[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
return G__10695__delegate(args);
});
...
var old_10698 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_10698))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_10698)].join(''):class$));
} else {
}
...
var G__10701 = jsprops;
(G__10701["defaultValue"] = value);

(G__10701["onChange"] = ((function (G__10701,v,value,on_change){
return (function (p1__10699_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10699_SHARP_);
});})(G__10701,v,value,on_change))
);
...
var vec__10703 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10703,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10703,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10703,(2),null);
...
var temp__4427__auto__ = (function (){var G__10707 = cljs.core.meta(v);
var G__10707__$1 = (((G__10707 == null))?null:reagent.impl.template.get_key(G__10707));
return G__10707__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__10709_10710 = v;
var G__10709_10711__$1 = (((G__10709_10710 == null))?null:reagent.impl.template.key_from_vec(G__10709_10710));
var G__10709_10712__$2 = (((G__10709_10711__$1 == null))?null:(jsprops["key"] = G__10709_10711__$1));
...
var G__10716 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10716) : reagent.impl.template.as_element.call(null,G__10716));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__10717 = cljs.core.meta(argv);
var G__10717__$1 = (((G__10717 == null))?null:reagent.impl.template.get_key(G__10717));
return G__10717__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__10718 = (((jsprops == null))?{}:jsprops);
(G__10718["key"] = key);
...
var G__10719 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__10719;
continue;
}
} else {
...
var n__5571__auto___10720 = a.length;
var i_10721 = (0);
while(true){
if((i_10721 < n__5571__auto___10720)){
(a[i_10721] = reagent.impl.template.as_element((a[i_10721])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5571__auto___10723 = a.length;
var i_10724 = (0);
while(true){
if((i_10724 < n__5571__auto___10723)){
var val_10725 = (a[i_10724]);
if((cljs.core.vector_QMARK_(val_10725)) && ((reagent.impl.template.key_from_vec(val_10725) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10724] = reagent.impl.template.as_element(val_10725));
...
var G__10728 = (cljs.core.count(argv) - first_child);
switch (G__10728) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__10728){
